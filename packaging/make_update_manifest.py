...
uploads):
    ...
    Niash-macos-arm64.app.tar.gz(.sig)   -> platforms["darwin-aarch64"]
    Niash-macos-x64.app.tar.gz(.sig)     -> platforms["darwin-x86_64"]
    Niash-windows-setup.exe(.sig)        -> platforms["windows-x86_64"]
...
The desktop app finds this file through https://download.nish.com/latest.json
...
ARTIFACTS = {
    "Niash-macos-arm64.app.tar.gz": "darwin-aarch64",
    "Niash-macos-x64.app.tar.gz": "darwin-x86_64",
    "Niash-windows-setup.exe": "windows-x86_64",
}
