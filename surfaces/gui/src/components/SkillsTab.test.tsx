...
describe("SkillsTab", () => {
  ...
  it("Add skill menu: three doors; Create with Niash hands off to a conversation", async () => {
    ...
    fireEvent.click(screen.getByText("Create with Niash"));
  ...
  it("the list is the page: no standing add-surfaces, no drafting remnants", async () => {
    ...
    expect(screen.queryByText("Ask Niash to revise")).toBeNull();
