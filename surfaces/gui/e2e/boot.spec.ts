// Cold-boot fixes (owner-hit 2026-07-23): the splash wears the real Niash mark
...
test("boot splash shows the Niash star, not the sparkle glyph", async ({ page }) => {
  ...
  await expect(page.getByText(/Starting Niash|Restoring your session/)).toBeVisible();
});
